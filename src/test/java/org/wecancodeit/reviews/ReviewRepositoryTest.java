...
public class ReviewRepositoryTest {
	...
	private Review firstReview=new Review(firstReviewId, "title", "image url", "review category", "content");
	
	
	private long secondReviewId=2L;
	private Review secondReview=new Review(secondReviewId, "title", "image url", "review category", "content");
